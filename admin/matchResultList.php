<?php 
	...
	$round_data = $action->getmatchResult($_GET['tournament_key']);
						...
						<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="scorecardResultList.php?tournament_key=<?php echo $value->tournament_key; ?>&match_key=<?php echo $value->match_key; ?>" class="btn-sm btn-success" title="Show Scorecard"><i class="fa fa-eye"></i></a>
									</td>
								</tr>
								<?php $i++; } ?>
							</tbody>
