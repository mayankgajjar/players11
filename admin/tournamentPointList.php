<?php 
	...
	$result_data = $action->getTournamentPointResult();
						...
						<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="matchPointResultList.php?tournament_key=<?php echo $value->tournament_key; ?>" class="btn-sm btn-success" title="Show Match"><i class="fa fa-eye"></i></a>
									</td>
								</tr>
								<?php $i++; } ?>
							</tbody>
