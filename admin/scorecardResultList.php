<?php 
	...
	$round_data = $action->getMatchScorecard($data);
						...
						<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="ScorecardResultList.php?id=<?php echo $value->scard_id; ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Show Scorecard"><i class="fa fa-eye"></i></a>

										<a href="editScorecardResult.php?id=<?php echo $value->scard_id; ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill" title="Edit">
