<?php 
	...
	$result_data = $action->getUserTournamentResult();
						...
						<table class="table table-striped- table-bordered table-hover table-checkable" id="m_table_2">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<a href="matchUserResultList.php?tournament_key=<?php echo $value->tournament_key; ?>" class="btn-sm btn-success" title="Show Match"><i class="fa fa-eye"></i></a>
									</td>
								</tr>
								<?php $i++; } ?>
							</tbody>
